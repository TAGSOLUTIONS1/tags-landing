...
const CareerCardBenefit: React.FC = () => {
  return (
    <div className="p-6 flex justify-center items-center">
      <div className="flex flex-col md:flex-row w-full max-w-[930px] h-auto md:h-[300px] rounded-xl bg-[#4F4A45] overflow-hidden">
        <Image
          src="/images/career4.jpeg"
          alt="Career Benefits"
          className="w-full md:w-[350px] h-[200px] md:h-full object-cover"
          width={500}
          height={300}
        />
        <div className="flex flex-col p-6">
          <h1 className="text-orange-primary font-semibold text-2xl md:text-[30px] mb-3">
            Our Benefits
          </h1>
