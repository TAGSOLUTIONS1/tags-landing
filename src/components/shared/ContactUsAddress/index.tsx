...
const ContactUsAddress: React.FC = () => {
  return (
    <div className="p-6 flex justify-center items-center">
      <div className="rounded-[15px] drop-shadow-lg flex justify-center items-center w-full max-w-[1100px]">
        <div className="flex">
          <div className="rounded-[15px] drop-shadow-lg">
            <h1 className="p-3 flex justify-center items-center font-semibold hover:text-orange-case">
              UAE Branch
            </h1>
            <iframe
              className="rounded-[15px] drop-shadow-lg m-3"
