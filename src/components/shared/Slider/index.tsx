...
const slides = [
    {
        ...
        description: "Unlock new levels of innovation and efficiency with our cutting-edge generative AI solutions.",
    },
    {
        text: "Revolutionize Your Workflow",
        description: "Leverage AI to streamline your processes and achieve unprecedented productivity.",
    },
    {
        text: "The Future of AI is Here",
        description: "Join the AI revolution and stay ahead of the curve with our innovative solutions.",
    }
];
                ...
                {slides.map((slide, index) => (
                    ...
                    >
                        <div className="lg:w-1/2 w-full text-left">
                            ...
                            <div className='mt-1'><Paragraph color='black' title={slide.description}></Paragraph></div>
                            <div className="mt-5">
