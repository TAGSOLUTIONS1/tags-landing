    ...
    <div className="relative w-full h-screen mt-20 shadow-globe">
      ...
      <div className="z-10 flex flex-col w-full h-full text-white" >
        <div className='lg:w-2/6 sm:text-center lg:text-left lg:ml-48 relative top-36'>
            <Heading title={"Transform Your Business with Global B2B Solutions"} color={'light-white'}></Heading>
            <div className='mt-3'>
            <Paragraph title='Unlock limitless opportunities with our tailor-made B2B services. From anywhere on Earth, we deliver solutions that elevate your business to new heights. Start your global journey today!' 
            color='light-white'></Paragraph>
            </div>
