...
const Construction = () => {
  return (
    <>
      ...
      >
        <g filter="url(#filter0_d_474_924)">
        ...
        <defs>
          ...
          >
            ...
            <feMorphology
              ...
              operator="dilate"
              in="SourceAlpha"
              result="effect1_dropShadow_474_924"
            />
            <feOffset />
            ...
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_474_924"
              result="shape"
            />
          </filter>
